...
线程、主内存、工作内存三者的关系如图：
![在这里插入图片描述](imgs/a9b6f7f031f94b36a762693d35240f50.png)
...
![在这里插入图片描述](imgs/8fe4ce7a5d1f4892a72f4a2a97d26e43.png)
...
运行结果
![在这里插入图片描述](imgs/8252c5242de34618a9730ed3184d3325.png)
若不使用关键字 synchronized 运行结果
![在这里插入图片描述](imgs/194bc461580047cc8f049c92c92e5e78.png)
...
>
> 运行结果：
> ![在这里插入图片描述](imgs/0ac3eacd9e9f48219aca62b2cd5aa85e.png)
...
运行结果：
![在这里插入图片描述](imgs/6a1f3e9039f64aa6b717e8d045db5a6d.png)
...
![在这里插入图片描述](imgs/04233edb68ee4d14af076ed5a40fb0d6.png)
...
![在这里插入图片描述](imgs/2c04374ad4d3408bb76238442af64aa9.png)
**（3）Lock 使用场景**
...
**（5）Lock 接口基本的方法**
![在这里插入图片描述](imgs/17ae62bf674d42c08f950213b25e94ac.png)

**（6）ReentrantLock 类基本方法**
![在这里插入图片描述](imgs/4a3c9109e34e4195b8b23fd95bd2139a.png)
![在这里插入图片描述](imgs/fd0cf306df294030b3aff112e5496167.png)
**（7）ReadWriteLock 接口**
