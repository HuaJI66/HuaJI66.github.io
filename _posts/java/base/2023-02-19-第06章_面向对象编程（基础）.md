---
layout: post
title: 基础-第06章_面向对象编程（基础）.md
subtitle: 三更灯火五更鸡，正是男儿读书时。
categories: java
tags: [基础]
banner:
...
![第2阶段：Java面向对象编程-第06章](/assets/images/java/base/1/第2阶段：Java面向对象编程-第06章.png)
...
<img src="/assets/images/java/base/1/面向过程的思考.png" alt="image-20220520154055429" style="zoom: 90%;" />
...
<img src="/assets/images/java/base/1/a49bd1fc8152291f0c5b43ee3322672d.png" alt="a49bd1fc8152291f0c5b43ee3322672d" style="zoom: 25%;" />

自然地，我们就会从“车由什么组成”开始思考。发现，车由如下结构组成：

<img src="/assets/images/java/base/1/image-20220520155357634.png" alt="image-20220520155357634" style="zoom: 67%;" />
...
![tuandui](/assets/images/java/base/1/tuandui.jpg)
...
<img src="/assets/images/java/base/1/image-20220319180839009.png" alt="image-20220319180839009" style="zoom:80%;" />

### 1.3 如何掌握这种思想？

<img src="/assets/images/java/base/1/image-20220319180301856.png" alt="image-20220319180301856" style="zoom: 67%;" />
...
<img src="/assets/images/java/base/1/image-20220520162643547.png" alt="image-20220520162643547" style="zoom:67%;" />
...
![image-20220319210405983](/assets/images/java/base/1/image-20220319210405983.png)

可以理解为：`类 => 抽象概念的人`；`对象 => 实实在在的某个人`

***

<img src="/assets/images/java/base/1/iphone13promax.jpeg" style="zoom:85%;" />

***

<img src="/assets/images/java/base/1/image-20220503101940126.png" alt="image-20220503101940126" style="zoom:67%;" />
...
![image-20220319214213898](/assets/images/java/base/1/image-20220319214213898.png)
...
- 现实世界的生物体，大到鲸鱼，小到蚂蚁，都是由最基本的`细胞`构成的。同理，Java代码世界是由诸多个不同功能的`类`构成的。
  ...
  <img src="/assets/images/java/base/1/image-20220319211527249.png" alt="image-20220319211527249" style="zoom:67%;" />
...
<img src="/assets/images/java/base/1/20220319_211611.jpg" alt="20220319_211611" style="zoom: 67%;" />

- 举例：

![image-20220319211859026](/assets/images/java/base/1/image-20220319211859026.png)
...
<img src="/assets/images/java/base/1/image-20220319213201568.png" alt="image-20220319213201568" style="zoom: 50%;" />
...
图示理解：![image-20220319213753668](/assets/images/java/base/1/image-20220319213753668.png)
...
![JVM架构-简图](/assets/images/java/base/1/JVM架构-简图.png)
...
<img src="/assets/images/java/base/1/image-20220319215723183.png" alt="image-20220319215723183" style="zoom:67%;" />
...
![1561597909862](/assets/images/java/base/1/1561597909862.png)
...
<img src="/assets/images/java/base/1/image-20220511101608038.png" alt="image-20220511101608038" style="zoom:67%;" />

<img src="/assets/images/java/base/1/image-20220319230744617.png" alt="image-20220319230744617" style="zoom:80%;" />
...
<img src="/assets/images/java/base/1/image-20220319231821747.png" alt="image-20220319231821747" style="zoom:80%;" />
...
<img src="/assets/images/java/base/1/image-20220319231703240.png" alt="image-20220319231703240" style="zoom:80%;" />

## 5. 类的成员之二：方法(method)

### 5.1 方法的引入

<img src="/assets/images/java/base/1/街头霸王&超级玛丽.jpg"/>
...
<img src="/assets/images/java/base/1/image-20220320000047155.png" alt="image-20220320000047155" style="zoom: 50%;" />

**2、类比举例**

<img src="/assets/images/java/base/1/image-20220503102323689.png" alt="image-20220503102323689" style="zoom:67%;" />
...
![image-20220524104951449](/assets/images/java/base/1/image-20220524104951449.png)

### 5.8 练习

**练习1：**创建一个Person类，其定义如下：

<img src="/assets/images/java/base/1/image-20220320001337145.png" alt="image-20220320001337145" style="zoom:67%;" />
...
![image-20220320001627445](/assets/images/java/base/1/image-20220320001627445.png)
...
![image-20211228153827819](/assets/images/java/base/1/image-20211228153827819.png)
...
![image-20221120153322455](/assets/images/java/base/1/image-20221120153322455.png)
...
![image-20221120153442447](/assets/images/java/base/1/image-20221120153442447.png)
...
<img src="/assets/images/java/base/1/20220320_233145.jpg" alt="20220320_233145" style="zoom:80%;" />

练习4：`貌似是`考查方法的参数传递

![image-20220320233402122](/assets/images/java/base/1/image-20220320233402122.png)
...
![image-20220320233626003](/assets/images/java/base/1/image-20220320233626003.png)

### 7.4 递归(recursion)方法

举例1：

<img src="/assets/images/java/base/1/image-20220521160246138.png" alt="image-20220521160246138" style="zoom: 67%;" />
...
![](/assets/images/java/base/1/递归.png)
...
![image-20220520150018655](/assets/images/java/base/1/image-20220520150018655.png)
...
![image-20220320235105406](/assets/images/java/base/1/image-20220320235105406.png)
...
<img src="/assets/images/java/base/1/image-20220320235229941.png" alt="image-20220320235229941" style="zoom:67%;" />
...
![image-20220321233025157](/assets/images/java/base/1/image-20220321233025157.png)
...
![image-20220321233153448](/assets/images/java/base/1/image-20220321233153448.png)
...
<img src="/assets/images/java/base/1/image-20220321222327616.png" alt="image-20220321222327616" style="zoom:67%;" />

<img src="/assets/images/java/base/1/image-20220617164042390.png" alt="image-20220617164042390" style="zoom:80%;" />
...
<img src="/assets/images/java/base/1/image-20220321223633916.png" alt="image-20220321223633916" style="zoom:80%;" />
...
1. 当我们没有显式的声明类中的构造器时，系统会默认提供一个无参的构造器并且该构造器的修饰符默认与类的修饰符相同
   ...
   ![image-20220524143937454](/assets/images/java/base/1/image-20220524143937454.png)
...
包含的方法：访问器方法（getter和setter方法），取款方法withdraw()，存款方法deposit()。
 ...
 ![image-20220321235241752](/assets/images/java/base/1/image-20220321235241752.png)

**提示：**在提款方法withdraw中，需要判断用户余额是否能够满足提款数额的要求，如果不能，应给出提示。

2. 创建Customer类。

 ![image-20220321235324156](/assets/images/java/base/1/image-20220321235324156.png)
...
<img src="/assets/images/java/base/1/image-20220321232230831.png" alt="image-20220321232230831" style="zoom:80%;" />

![image-20220503111301602](/assets/images/java/base/1/image-20220503111301602.png)
