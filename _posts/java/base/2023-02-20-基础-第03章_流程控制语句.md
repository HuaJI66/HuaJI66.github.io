---
layout: post
title: 基础-第03章_流程控制语句
subtitle: 霾两轮兮絷四马，援玉枹兮击鸣鼓。
categories: java
tags: [基础]
banner:
...
<img src="/assets/images/java/base/1/第1阶段：Java基本语法-第03章.png" alt="第1阶段：Java基本语法-第03章" style="zoom:45%;" />
...
<img src="/assets/images/java/base/1/洗衣流程.jpg" alt="洗衣流程" style="zoom:100%;" />

## 1. 顺序结构

顺序结构就是程序`从上到下逐行`地执行。表达式语句都是顺序执行的。并且上一行对某个变量的修改对下一行会产生影响。

![image-20211218093256771](/assets/images/java/base/1/image-20211218093256771.png )
...
![image-20220514160139926](/assets/images/java/base/1/image-20220514160139926.png)
...
![image-20220514160243421](/assets/images/java/base/1/image-20220514160243421.png)
...
![image-20220514160538651](/assets/images/java/base/1/image-20220514160538651.png)
...
![image-20221027185234087](/assets/images/java/base/1/image-20221027185234087.png)

![image-20221027185500389](/assets/images/java/base/1/image-20221027185500389.png)
...
![image-20220514101841710](/assets/images/java/base/1/image-20220514101841710.png)
...
![image-20220314005350344](/assets/images/java/base/1/image-20220314005350344.png)
...
![1659112038716](/assets/images/java/base/1/1659112038716.png)
...
<img src="/assets/images/java/base/1/image-20220315013023236.png" alt="image-20220315013023236" style="zoom:80%;" />
...
<img src="/assets/images/java/base/1/image-20220315013722962.png" alt="image-20220315013722962" style="zoom:67%;" />
...
<img src="/assets/images/java/base/1/image-20220512165558698.png" alt="image-20220512165558698" style="zoom:80%;" />
...
![类似：死循环](/assets/images/java/base/1/类似：死循环.jpg)
...
![image-20221113193013204](/assets/images/java/base/1/image-20221113193013204.png)
