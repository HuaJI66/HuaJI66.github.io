---
layout: post
title: 基础-第18章_JDK8-17新特性（下）.md
subtitle: 朽木不可雕也，粪土之墙不可圬也！
categories: java
tags: [基础]
banner:
...
- 调出jShell
 ...
 ![image-20220527205410620](/assets/images/java/base/1/image-20220527205410620.png)

- 获取帮助


 ![image-20220527205418073](/assets/images/java/base/1/image-20220527205418073.png)

- 基本使用


 ![image-20220527205429720](/assets/images/java/base/1/image-20220527205429720.png)

- 导入指定的包


 ![image-20220527205440068](/assets/images/java/base/1/image-20220527205440068.png)

- 默认已经导入如下的所有包：（包含java.lang包）


 ![image-20220527205445267](/assets/images/java/base/1/image-20220527205445267.png)

- 只需按下 Tab 键，就能自动补全代码


 ![image-20220527205451352](/assets/images/java/base/1/image-20220527205451352.png)

- 列出当前 session 里所有有效的代码片段


 ![image-20220527205458774](/assets/images/java/base/1/image-20220527205458774.png)

- 查看当前 session 下所有创建过的变量


 ![image-20220527205506632](/assets/images/java/base/1/image-20220527205506632.png)

- 查看当前 session 下所有创建过的方法


 ![image-20220527205513459](/assets/images/java/base/1/image-20220527205513459.png)
...
- 使用外部代码编辑器来编写 Java 代码
 ...
 ![image-20220527205519915](/assets/images/java/base/1/image-20220527205519915.png)
...
- 使用/open命令调用
 ...
 ![image-20220527205827712](/assets/images/java/base/1/image-20220527205827712.png)

- 退出jShell


 ![image-20220527205904000](/assets/images/java/base/1/image-20220527205904000.png)
...
声明一个成员变量，并初始化值为null
 ...
 ![image-20220528155628337](/assets/images/java/base/1/image-20220528155628337.png)

声明一个数组变量，并为数组静态初始化（省略new的情况下）

 ![image-20220528155436304](/assets/images/java/base/1/image-20220528155436304.png)

没有初始化的方法内的局部变量声明

 ![image-20220528155525774](/assets/images/java/base/1/image-20220528155525774.png)

方法的返回值类型

 ![image-20220528155537713](/assets/images/java/base/1/image-20220528155537713.png)

方法的参数类型

 ![image-20220528155549303](/assets/images/java/base/1/image-20220528155549303.png)

构造器的参数类型

 ![image-20220528155614708](/assets/images/java/base/1/image-20220528155614708.png)

作为catch块中异常类型

 ![image-20220528155640498](/assets/images/java/base/1/image-20220528155640498.png)

Lambda表达式中函数式接口的类型

 ![image-20220528155423180](/assets/images/java/base/1/image-20220528155423180.png)

方法引用中函数式接口的类型

 ![image-20220528155429055](/assets/images/java/base/1/image-20220528155429055.png)
...
![image-20220527233322495](/assets/images/java/base/1/image-20220527233322495.png)
...
![image-20220528212254705](/assets/images/java/base/1/image-20220528212254705.png)
...
![image-20220528212323729](/assets/images/java/base/1/image-20220528212323729.png)
...
![image-20220528212414676](/assets/images/java/base/1/image-20220528212414676.png)

![image-20220528212421319](/assets/images/java/base/1/image-20220528212421319.png)
