...
<img src="/assets/images/java/base/1/第3阶段：Java高级应用-第11章.png" alt="第3阶段：Java高级应用-第11章" style="zoom:50%;" />
...
- String对象的字符内容是存储在一个字符数组value[]中的。`"hello"` 等效于 `char[] data={'h','e','l','l','o'}`。
  ...
  <img src="/assets/images/java/base/1/image-20220514184404024.png" alt="image-20220514184404024" style="zoom:80%;" />
...
![image-20220405160036240](/assets/images/java/base/1/1562945799274.png)
...
<img src="/assets/images/java/base/1/image-20220405152839525.png" alt="image-20220405152839525" style="zoom:67%;" />

进一步：

<img src="/assets/images/java/base/1/image-20220405152941599.png" alt="image-20220405152941599" style="zoom:67%;" />
...
<img src="/assets/images/java/base/1/image-20220405153027693.png" alt="image-20220405153027693" style="zoom:67%;" />

#### 1.2.3 练习类型2：new

String str1 = “abc”; 与 String str2 = new String(“abc”);的区别？

<img src="/assets/images/java/base/1/image-20220405160149200.png" alt="image-20220405160149200" style="zoom:67%;" />
...
<img src="/assets/images/java/base/1/image-20220405160321172.png" alt="image-20220405160321172" style="zoom:67%;" />
...
- java.lang.StringBuffer代表`可变的字符序列`，JDK1.0中声明，可以对字符串内容进行增删，此时不会产生新的对象。比如：
  ...
  ![image-20220405221714261](/assets/images/java/base/1/image-20220405221714261.png)

<img src="/assets/images/java/base/1/image-20220228153030902.png" alt="image-20220228153030902" style="zoom:80%;" />


- 继承结构：


 ![image-20220405174233055](/assets/images/java/base/1/image-20220405174233055.png)

 <img src="/assets/images/java/base/1/image-20220405174414780.png" alt="image-20220405174414780" style="zoom:67%;" />
...
>
>    ![image-20220405223542750](/assets/images/java/base/1/image-20220405223542750.png)
...
空参数构造时,初始char数组的容量为16,append操作如果字符串为null则会将字符串“null”追加上去
...
![image-20230219223256240](imgs/image-20230219223256240.png)
...
![1572599023197](/assets/images/java/base/1/1572599023197.png)
...
<img src="/assets/images/java/base/1/image-20220511105252261.png" alt="image-20220511105252261" style="zoom:67%;" />
...
- 获取Calendar实例的方法
  ...
  - 使用`Calendar.getInstance()`方法
    ...
    ![image-20220123184906903](/assets/images/java/base/1/image-20220123184906903.png)

  - 调用它的子类GregorianCalendar（公历）的构造器。

    ![image-20220405225828816](/assets/images/java/base/1/image-20220405225828816.png)
...
- 常用字段
  ...
  ![1620277709044](/assets/images/java/base/1/1620277709044.png)
...
<img src="/assets/images/java/base/1/image-20220503120722810.png" alt="image-20220503120722810" style="zoom:67%;" />
...
![image-20220406000442908](/assets/images/java/base/1/image-20220406000442908.png)
...
![image-20220406001726285](/assets/images/java/base/1/image-20220406001726285.png)
...
- 成员方法
  ...
  - `String getProperty(String key)`：
    ...
    ![image-20220406003340258](/assets/images/java/base/1/image-20220406003340258.png)
